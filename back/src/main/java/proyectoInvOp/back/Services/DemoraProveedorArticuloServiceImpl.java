...
@Service
public class DemoraProveedorArticuloServiceImpl extends BaseServiceImpl<ProveedorArticulo,Long> implements DemoraProveedorArticuloService{
    @Autowired
    DemoraProveedorArticuloRepository demoraProveedorArticuloRepository;
    public DemoraProveedorArticuloServiceImpl(BaseRepository<ProveedorArticulo, Long> baseRepository) {
